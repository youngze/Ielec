...
<FRAME name=topFrame src="title.jsp" noResize scrolling=no>
...
<frame name="changeButton" src="${pageContext.request.contextPath }/menu/change1.jsp" frameBorder=0 marginHeight=0 marginWidth=0 scrolling=no noresize>
